...
export const Button = styled.button.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && ![
      'borderRadius', 'block', 'iconSize', 'left', 'right', 'dark', 'elevated',
      'padding', 'fontSize', 'fontWeight', 'color', 'outlined'
    ].includes(prop)
})`
...
export const BtnIcon = styled.div.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && !['iconSize', 'left', 'right', 'color'].includes(prop)
})`
...
export const IconButton = styled.div.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && !['iconSize', 'color', 'disabled'].includes(prop)
})`
  font-size: ${props => props.iconSize ? props.iconSize : '23px'};
  height: ${props => props.iconSize ? props.iconSize : '23px'};
  color: ${props => props.color ? props.color : '#000'};
...
export const AvatarButton = styled.div.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && !['size', 'color', 'raised', 'disabled'].includes(prop)
})`
...
export const AvatarBtnIcon = styled.div.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && !['iconSize', 'color'].includes(prop)
})`
  font-size: ${props => props.iconSize ? props.iconSize : '23px'};
  height: ${props => props.iconSize ? props.iconSize : '23px'};
  color: ${props => props.color ? props.color : '#000'};
...
export const AvatarBtnText = styled.div.withConfig({
  shouldForwardProp: (prop, defaultValidatorFn) =>
    (typeof defaultValidatorFn === 'function' ? defaultValidatorFn(prop) : true) && !['fontSize', 'padding', 'fontWeight', 'color'].includes(prop)
})`
  font-size: ${props => props.fontSize ? props.fontSize : '16px'};
