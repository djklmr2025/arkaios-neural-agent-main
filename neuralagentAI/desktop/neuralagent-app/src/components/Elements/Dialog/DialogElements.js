...
export const DialogContainer = styled.div.withConfig({
  shouldForwardProp: (prop) => !['maxWidth','isDarkMode'].includes(prop)
})`
  position: fixed;
  z-index: 1000;
  width: 90%;
...
export const HeaderEnd = styled.div.withConfig({
...
export const DialogTitle = styled.div.withConfig({
...
export const DialogContent = styled.div.withConfig({
  shouldForwardProp: (prop) => !['padding','scrollable','height'].includes(prop)
})`
