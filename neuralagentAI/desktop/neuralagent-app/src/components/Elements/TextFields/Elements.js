...
export const TextFieldLabel = styled.div.withConfig({
  shouldForwardProp: (prop) => !['fontSize','fontWeight','isDarkMode','verticalLabel'].includes(prop)
})`
...
export const TextField = styled.input.withConfig({
  shouldForwardProp: (prop) => !['background','padding','isDarkMode','fontSize','borderRadius','outlined'].includes(prop)
})`
